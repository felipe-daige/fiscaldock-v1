    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        @if(in_array($statusLote, ['pendente', 'processando'], true))
            <div id="clearance-resultado-progresso" class="bg-white rounded border border-gray-300 overflow-hidden mb-4">
                ...
                <div class="p-4">
                    ...
                    <p id="clearance-resultado-etapa" class="text-xs text-gray-600 mt-3">Iniciando clearance...</p>
        ...
        @if($statusLote === 'erro')
            <div class="bg-white rounded border border-gray-300 p-4 mb-4 border-l-4 border-l-red-500">
                ...
                <p class="mt-2 text-sm text-gray-700">{{ $lote->error_message ?: 'O provedor externo retornou erro para este lote.' }}</p>
            </div>
        @endif
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach($resultados as $resultado)
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-3 py-3 text-sm font-semibold text-gray-900 text-right font-mono">{{ $resultado->valor_total_label }}</td>
                                    <td class="px-3 py-3">
                                    ...
                                    <td class="px-3 py-3 text-right">
                                        @if($resultado->detalhe_url)
                                            <a href="{{ $resultado->detalhe_url }}" data-link class="text-xs text-gray-700 hover:text-gray-900 hover:underline">Ver documento</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
