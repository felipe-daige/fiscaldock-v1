...
<div class="bg-white rounded border border-gray-300 mt-6" id="resumo-final-section">
 ...
 @else
 <a href="/app/notas/acervo?importacao_id={{ $importacao->id }}" data-link class="flex items-center justify-between py-1.5 border-b border-gray-100 last:border-0 hover:bg-gray-50/50 rounded transition-colors group/link">
 <div class="flex items-center gap-2">
 <span class="text-gray-700 font-bold w-4 text-center">✓</span>
 ...
 {{-- Total --}}
 @if(!empty($rf['totais']))
 <a href="/app/notas/acervo?importacao_id={{ $importacao->id }}" data-link class="flex items-center justify-between py-2 border-t border-gray-300 mt-1 hover:bg-gray-50/50 rounded transition-colors group/link">
 <div class="flex items-center gap-2">
 <span class="w-4"></span>
